...
from canopact.blueprints.admin.models import Dashboard
from canopact.blueprints.user.decorators import role_required
from canopact.blueprints.billing.decorators import handle_stripe_exceptions
...
from canopact.blueprints.admin.forms import (
    SearchForm,
    BulkDeleteForm,
    UserForm,
...
def users_bulk_delete():
    ...
    if form.validate_on_submit():
        ...
        from canopact.blueprints.billing.tasks import delete_users
...
def coupons_bulk_delete():
    ...
    if form.validate_on_submit():
        ...
        # Prevent circular imports.
        from canopact.blueprints.billing.tasks import delete_coupons
